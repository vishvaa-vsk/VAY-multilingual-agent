...
class SessionContext:
    ...
    pending_action: Optional[dict] = None  # {"tool": "changePlan"|"sendPaymentLink", "args": {...}, "summary": str}
...
def confirm_pending_action(session: SessionContext, customer_said_yes: bool) -> Optional[str]:
