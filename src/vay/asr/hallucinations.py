...
HALLUCINATION_BLACKLIST: dict[str, set[str]] = {
    "en": {
        ...
        "thank you very much", "thank you very much for coming", "that i thought id just like to talk about for a minute","thank you so much for joining us", "thank you so much for joining us today", "im going to be here to give you more money", "we have to be cool", "im so glad to be here",
